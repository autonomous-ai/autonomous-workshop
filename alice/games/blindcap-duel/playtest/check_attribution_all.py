...
candidates = sorted(glob.glob("games/blindcap-duel/**/factory-page.json", recursive=True)
                    + glob.glob("games/blindcap-duel/**/page.json", recursive=True)
                    + glob.glob("games/blindcap-duel/**/content/*.json", recursive=True))
