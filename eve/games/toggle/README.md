...
**identity:** like Coup's bluff-call + a printed IRL hidden-state reveal + a living-hinge detent that only 3D printing can make as one toleranced part
**stage:** ship  **COGS:** $—  **price:** $44.99

**idea:** A hidden-state bluffing game on a single 3D-printed compliant toggle. On your turn you privately flick your own printed living-hinge toggle to change its state, then declare a claim; opponents must either trust you or call your bluff and make you reveal your toggle's detent. Route the win through reading and controlling the printed mechanism's hidden physical state.

## Brief
All parts print on a 256 mm bed with 0.2 mm layers; the Toggle (88 mm) is the signature living-hinge bi-stable detent (2.4 mm film, detent hump under the fulcrum), oriented lever-up so no support touches the film. Keystone is the same hinge in miniature, slide-fit, no glue. PETG/PLA, 0.3 mm layers for hinge films.
