...
`<WORKSHOP_RUN>/artifacts/make/r0001/product/cad/part_canopy_end_join_front.step.py --nozzle 0.4 --report <WORKSHOP_RUN>/artifacts/make/r0001/product/cad/measure/rounds/r0013/thickness-canopy_end_join_front.md`
