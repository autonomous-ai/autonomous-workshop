...
`<WORKSHOP_RUN>/artifacts/make/r0001/product/cad/part_access_lever.step.py --nozzle 0.4 --report <WORKSHOP_RUN>/artifacts/make/r0001/product/cad/measure/rounds/r0007/thickness-access_lever.md`
