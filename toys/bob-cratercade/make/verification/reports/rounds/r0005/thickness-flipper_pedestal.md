...
`<WORKSHOP_RUN>/artifacts/make/r0001/product/cad/part_flipper_pedestal.step.py --nozzle 0.4 --report <WORKSHOP_RUN>/artifacts/make/r0001/product/cad/measure/rounds/r0005/thickness-flipper_pedestal.md`
