...
`<WORKSHOP_RUN>/artifacts/make/r0001/product/cad/part_return_floor_1.step.py --nozzle 0.4 --report <WORKSHOP_RUN>/artifacts/make/r0001/product/cad/measure/rounds/r0005/thickness-return_floor_1.md`
