...
`<WORKSHOP_RUN>/artifacts/make/r0001/product/cad/part_mission_crater.step.py --nozzle 0.4 --report <WORKSHOP_RUN>/artifacts/make/r0001/product/cad/measure/rounds/r0005/thickness-mission_crater.md`
