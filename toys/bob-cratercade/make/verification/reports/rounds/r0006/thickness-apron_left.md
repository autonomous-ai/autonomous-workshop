...
`<WORKSHOP_RUN>/artifacts/make/r0001/product/cad/part_apron_left.step.py --nozzle 0.4 --report <WORKSHOP_RUN>/artifacts/make/r0001/product/cad/measure/rounds/r0006/thickness-apron_left.md`
