...
`<WORKSHOP_RUN>/artifacts/make/r0001/product/cad/part_flipper_right_rotor.step.py --nozzle 0.4 --report <WORKSHOP_RUN>/artifacts/make/r0001/product/cad/measure/rounds/r0009/thickness-flipper_right_rotor.md`
