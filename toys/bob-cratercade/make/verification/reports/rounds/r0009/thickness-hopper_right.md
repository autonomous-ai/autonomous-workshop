...
`<WORKSHOP_RUN>/artifacts/make/r0001/product/cad/part_hopper_right.step.py --nozzle 0.4 --report <WORKSHOP_RUN>/artifacts/make/r0001/product/cad/measure/rounds/r0009/thickness-hopper_right.md`
