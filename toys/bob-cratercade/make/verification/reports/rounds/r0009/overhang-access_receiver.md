...
`<WORKSHOP_RUN>/artifacts/make/r0001/product/cad/part_access_receiver.step.py --angle 45.0 --report <WORKSHOP_RUN>/artifacts/make/r0001/product/cad/measure/rounds/r0009/overhang-access_receiver.md`

part_access_receiver.step.py: 351.3 cm2 of surface, grid 0.441 mm, 2182 unsupported samples over 9 region(s)
