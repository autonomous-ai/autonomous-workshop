...
`<WORKSHOP_RUN>/artifacts/make/r0001/product/cad/part_return_floor_2.step.py --nozzle 0.4 --report <WORKSHOP_RUN>/artifacts/make/r0001/product/cad/measure/rounds/r0009/thickness-return_floor_2.md`
