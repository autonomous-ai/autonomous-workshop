...
`<WORKSHOP_RUN>/artifacts/make/r0001/product/cad/part_hopper_left.step.py --nozzle 0.4 --report <WORKSHOP_RUN>/artifacts/make/r0001/product/cad/measure/rounds/r0009/thickness-hopper_left.md`
