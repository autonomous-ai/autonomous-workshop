...
`<WORKSHOP_RUN>/artifacts/make/r0001/product/cad/part_orbit_inner_wall.step.py --nozzle 0.4 --report <WORKSHOP_RUN>/artifacts/make/r0001/product/cad/measure/rounds/r0009/thickness-orbit_inner_wall.md`
