...
`<WORKSHOP_RUN>/artifacts/make/r0001/product/cad/part_launch_divider_lower.step.py --nozzle 0.4 --report <WORKSHOP_RUN>/artifacts/make/r0001/product/cad/measure/rounds/r0009/thickness-launch_divider_lower.md`
