...
`<WORKSHOP_RUN>/artifacts/make/r0001/product/cad/part_apron_left.step.py --nozzle 0.4 --report <WORKSHOP_RUN>/artifacts/make/r0001/product/cad/measure/rounds/r0004/thickness-apron_left.md`
