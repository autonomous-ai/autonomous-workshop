...
`<WORKSHOP_RUN>/artifacts/make/r0001/product/cad/part_launch_divider_upper.step.py --nozzle 0.4 --report <WORKSHOP_RUN>/artifacts/make/r0001/product/cad/measure/rounds/r0004/thickness-launch_divider_upper.md`
