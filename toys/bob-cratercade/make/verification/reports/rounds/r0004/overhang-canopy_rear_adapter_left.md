...
`<WORKSHOP_RUN>/artifacts/make/r0001/product/cad/part_canopy_rear_adapter_left.step.py --angle 45.0 --report <WORKSHOP_RUN>/artifacts/make/r0001/product/cad/measure/rounds/r0004/overhang-canopy_rear_adapter_left.md`
