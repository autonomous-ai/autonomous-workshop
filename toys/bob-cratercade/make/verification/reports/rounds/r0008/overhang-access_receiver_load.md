...
`<WORKSHOP_RUN>/artifacts/make/r0001/product/cad/part_access_receiver_load.step.py --angle 45.0 --report <WORKSHOP_RUN>/artifacts/make/r0001/product/cad/measure/rounds/r0008/overhang-access_receiver_load.md`

part_access_receiver_load.step.py: 351.8 cm2 of surface, grid 0.441 mm, 2192 unsupported samples over 10 region(s)
