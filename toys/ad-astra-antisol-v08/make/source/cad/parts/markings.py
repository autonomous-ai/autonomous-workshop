...
Uranus is described entirely by latitude, because a belt of latitude is what
a band system actually is.  Neptune was too, and stopped being: its clouds are
arcs rather than bands, so its eight streaks and its dark spot are outline
rings like Earth's coastlines, drawn in `parts/neptune_atlas.py`.  Jupiter and,
...
MARKINGS = {
    ...
    "neptune": [
        ...
        ("streaks", "white", NEPTUNE_ATLAS.streak_specs(), ()),
        ...
        # reference shows inside the spot is not drawn.
