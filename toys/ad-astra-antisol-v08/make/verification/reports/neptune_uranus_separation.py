...
def main() -> int:
    ...
    print("| piece height mm | %.2f | %.2f | %.2f |"
          % (P.piece_height("neptune"), P.piece_height("uranus"),
             P.piece_height("uranus") - P.piece_height("neptune")))
    ...
    print("reader actually uses. Neptune wears eight short tapered wisps at eight")
    print("different angles plus a dark oval; Uranus wears one band, %.0f degrees"
          % 18.0)
    print("wide, running the whole way round the globe and stood upright by its")
    print("own 97.77 degree tilt. **They are distinguishable at table distance,")
    print("and comfortably so** -- but it is the paint doing it, not the ladder.")
    print()
    print("One thing that frame shows which is not this run's to fix. Uranus's")
    print("single band is exactly what Neptune's three bands were before this")
    print("correction: a closed belt of latitude, hard-edged, exactly parallel,")
    print("running right across the visible face. Next to eight short wisps it")
    print("now reads as the painted stripe on the pair. Uranus has not been")
    print("corrected at this point in the chain and is the last one still to")
    print("come; this is recorded rather than repaired here.")
    return 0
