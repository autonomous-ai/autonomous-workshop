...
The matching current-run check printed the following result. Its measured report content is identical to this final report; only command paths differ. Source: `rounds/r0001/thickness-fork_04.log` (SHA256 `6c7928780880560e641e82151b881343d4144eb7fdf8b1509a21ad385675649a`).
