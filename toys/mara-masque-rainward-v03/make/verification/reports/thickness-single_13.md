...
The matching current-run check printed the following result. Its measured report content is identical to this final report; only command paths differ. Source: `rounds/r0001/thickness-single_13.log` (SHA256 `60f87aa40ed2c868df69173063db920489677bb7fe25f1b023743f43e0e41c86`).
