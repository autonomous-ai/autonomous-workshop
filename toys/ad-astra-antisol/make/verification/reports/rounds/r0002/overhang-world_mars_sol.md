...
`<WORKSHOP_RUN>/artifacts/make/r0001/product/cad/part_world_mars_sol.step.py --angle 45.0 --report <WORKSHOP_RUN>/artifacts/make/r0001/product/cad/measure/rounds/r0002/overhang-world_mars_sol.md`
