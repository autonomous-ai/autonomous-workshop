...
`<WORKSHOP_RUN>/artifacts/make/r0001/product/cad/part_panel_southeast.step.py --nozzle 0.4 --report <WORKSHOP_RUN>/artifacts/make/r0001/product/cad/measure/component-rounds/panel_southeast/r0002/thickness-panel_southeast.md`
