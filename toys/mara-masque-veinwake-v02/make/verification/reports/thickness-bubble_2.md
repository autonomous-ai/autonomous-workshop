...
`cad/veinwake/part_bubble_2.step.py --nozzle 0.4 --report cad/veinwake/measure/thickness-bubble_2.md`

part_bubble_2.step.py: 6.79 cm3 solid, grid 0.133 mm (215x215x200), 161377 surface samples, thickness resolved to 0.067 mm
...
Manager-authored format bridge from the unchanged passing table above and final verifier exit 0; not an additional measurement. Raw reporter bytes: `raw-verifier-reports/thickness-bubble_2.md`, SHA-256 `ea620b1565b5e40cfd7e499381d631ccbd25195d86dd8221679a6d43ef51a284`.
