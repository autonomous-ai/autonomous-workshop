...
`cad/veinwake/part_bubble_4.step.py --nozzle 0.4 --report cad/veinwake/measure/thickness-bubble_4.md`
...
Manager-authored format bridge from the unchanged passing table above and final verifier exit 0; not an additional measurement. Raw reporter bytes: `raw-verifier-reports/thickness-bubble_4.md`, SHA-256 `a4550106ca21ea709b8b94800287fab89f9adaaf72af2bf3c853ba1c6c85b84e`.
