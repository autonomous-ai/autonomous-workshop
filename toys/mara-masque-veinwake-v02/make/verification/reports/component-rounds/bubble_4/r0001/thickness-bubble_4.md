...
`<WORKSHOP_RUN>/artifacts/make/r0001/product/cad/veinwake/part_bubble_4.step.py --nozzle 0.4 --report <WORKSHOP_RUN>/artifacts/make/r0001/product/cad/veinwake/measure/component-rounds/bubble_4/r0001/thickness-bubble_4.md`

part_bubble_4.step.py: 6.90 cm3 solid, grid 0.133 mm (215x215x200), 162076 surface samples, thickness resolved to 0.067 mm
