...
`cad/veinwake/part_bubble_3.step.py --nozzle 0.4 --report cad/veinwake/measure/thickness-bubble_3.md`

part_bubble_3.step.py: 6.79 cm3 solid, grid 0.133 mm (215x215x200), 161377 surface samples, thickness resolved to 0.067 mm
...
Manager-authored format bridge from the unchanged passing table above and final verifier exit 0; not an additional measurement. Raw reporter bytes: `raw-verifier-reports/thickness-bubble_3.md`, SHA-256 `caec8ca71382231cffd989e41661451a4e995d1c98b3f146a85c003893256699`.
