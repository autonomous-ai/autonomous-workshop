...
`cad/veinwake/part_tooth_1.step.py --nozzle 0.4 --report cad/veinwake/measure/thickness-tooth_1.md`
...
Manager-authored format bridge from the unchanged passing table above and final verifier exit 0; not an additional measurement. Raw reporter bytes: `raw-verifier-reports/thickness-tooth_1.md`, SHA-256 `4aaa9645a8a95cb32c3c5a3c338062164c59e046e2cd398d7578f14927ca7964`.
