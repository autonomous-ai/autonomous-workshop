...
```text
part_footboard.step.py: 0.60 cm3 solid, grid 0.133 mm (200x65x27), 30834 surface samples, thickness resolved to 0.067 mm
  PASS  wall >= 0.80 mm (+/-0.07)      0.0% of surface below (0 of 30834 samples)
  PASS  thickness distribution         median 2.93 mm, p95 25.93 mm, max 26.80 mm
  WARN  hollowable at 1.20 mm wall     0.07 of 0.60 cm3 (12%) in 1 pocket(s)
