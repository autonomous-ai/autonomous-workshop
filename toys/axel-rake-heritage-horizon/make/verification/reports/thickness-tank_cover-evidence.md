...
`artifacts/make/r0001/product/heritage/part_tank_cover.step.py --nozzle 0.4 --report artifacts/make/r0001/product/heritage/measure/thickness-tank_cover.md`
...
```text
part_tank_cover.step.py: 16.62 cm3 solid, grid 0.147 mm (331x195x175), 174527 surface samples, thickness resolved to 0.074 mm
  PASS  wall >= 0.80 mm (+/-0.07)      0.0% of surface below (0 of 174527 samples)
  PASS  thickness distribution         median 24.70 mm, p95 30.65 mm, max 47.33 mm
  WARN  hollowable at 1.20 mm wall     12.30 of 16.62 cm3 (74%) in 1 pocket(s)
  PASS  filament that would save       1.84 cm3, 2.3 g at 15% infill -- the slicer already leaves most of that space empty
