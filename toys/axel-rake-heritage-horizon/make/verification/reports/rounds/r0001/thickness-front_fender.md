...
`<WORKSHOP_RUN>/artifacts/make/r0001/product/heritage/part_front_fender.step.py --nozzle 0.4 --report <WORKSHOP_RUN>/artifacts/make/r0001/product/heritage/measure/rounds/r0001/thickness-front_fender.md`
