...
`<WORKSHOP_RUN>/artifacts/make/r0001/product/heritage/part_swingarm_side.step.py --nozzle 0.4 --report <WORKSHOP_RUN>/artifacts/make/r0001/product/heritage/measure/rounds/r0001/thickness-swingarm_side.md`
