...
`<WORKSHOP_RUN>/artifacts/make/r0001/product/heritage/part_footboard.step.py --nozzle 0.4 --report <WORKSHOP_RUN>/artifacts/make/r0001/product/heritage/measure/rounds/r0001/thickness-footboard.md`
