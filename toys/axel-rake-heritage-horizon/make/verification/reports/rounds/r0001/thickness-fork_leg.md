...
`<WORKSHOP_RUN>/artifacts/make/r0001/product/heritage/part_fork_leg.step.py --nozzle 0.4 --report <WORKSHOP_RUN>/artifacts/make/r0001/product/heritage/measure/rounds/r0001/thickness-fork_leg.md`
