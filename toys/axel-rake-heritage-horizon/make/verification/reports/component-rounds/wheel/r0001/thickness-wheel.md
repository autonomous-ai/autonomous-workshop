...
`<WORKSHOP_RUN>/artifacts/make/r0001/product/heritage/part_wheel.step.py --nozzle 0.4 --report <WORKSHOP_RUN>/artifacts/make/r0001/product/heritage/measure/component-rounds/wheel/r0001/thickness-wheel.md`
