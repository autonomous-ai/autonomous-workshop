...
from periastra_lib import build_base, build_roof, build_counter, build_inlay
...
def main():
    ...
    print('PASS: 58 named one-solid production STEP files, all bed-oriented; delivery assembly copied.')
