...
Round-4 Playtest repair: the fox uses a pointed low muzzle, two compact
triangular ears without flat caps, and an inward high brush that stays clear of
the portal rim. The owl retains the sealed no-facial-hole decision while using
a longer external beak, pear body, tapered angular wings, separated feet, and a
broad perch instead of three bat-like round lower lobes. All three states retain
the full five-case alignment challenge. The front home arrow is now shown in
exact assembled relationship to the reel's double-V, and a phone-shaped
through-opening with a widening three-step beam replaces the ambiguous six-tile
rear glyph. The rear bearing rib uses an 8 mm rounded land seated farther into
the shell, removing the fine-wall knife edge cited by round-3 Playtest.
