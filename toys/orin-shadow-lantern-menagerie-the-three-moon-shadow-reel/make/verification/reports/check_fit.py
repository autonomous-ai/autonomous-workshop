...
from lantern_menagerie_lib import (  # noqa: E402
    ...
    DETENT_POCKET_MOUTH_R,
    DETENT_POCKET_RAMP_DEPTH,
    DETENT_POCKET_R,
...
checks = {
    ...
    "hook_unloaded_negative_side_clearance_mm": HOOK_SLOT_W / 2 - HOOK_W / 2,
...
limits = {
    ...
    "hook_lead_x_clearance_mm": (0.39, 0.41),
    "hook_lead_y_clearance_mm": (0.39, 0.41),
    "hook_required_one_axis_flex_mm": (0.59, 0.61),
    "hook_positive_retention_overhang_mm": (0.59, 0.61),
    "hook_unloaded_negative_side_clearance_mm": (0.19, 0.21),
    "detent_nose_tip_radius_mm": (0.94, 0.96),
    "detent_pocket_ramp_radial_run_mm": (0.69, 0.71),
    "detent_pocket_ramp_depth_mm": (0.17, 0.19),
...
result = {
    ...
    "method": "Paired clearances, one-axis latch flex/retention, rounded detent tip, symmetric pocket ramps, and three index travels are independently derived from shared source constants; part builders do not restate a second nominal fit.",
