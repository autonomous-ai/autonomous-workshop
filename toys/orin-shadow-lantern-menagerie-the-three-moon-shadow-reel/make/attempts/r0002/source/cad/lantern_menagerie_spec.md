...
- Functional interfaces: 7.8 mm reel bore owns a 7.2 mm spindle derived with
  ...
  slots, 0.2 mm cam-entry clearance, and 0.3 mm retained overhang per side;
  rabbit home releases 0.25 mm more nominal leaf travel than fox/owl; 6 mm
...
Round-2 Playtest repair: the owl now keeps the authored positive body, wings,
and triangular tufts while adding broad connected facial-disc cheeks and
printable 1.2 mm tuft caps. The rear face is 3.2 mm thick with a faceted,
chamfered outer land and 24-facet minimum-44 mm portal; its explicit fine scan
must contain zero sub-0.8 mm samples. The reel has a non-periodic double-V home
mark, and the compliant interfaces are separated honestly into nominal fit
math, rigid retention/stop motion, and still-unverified physical behavior.
