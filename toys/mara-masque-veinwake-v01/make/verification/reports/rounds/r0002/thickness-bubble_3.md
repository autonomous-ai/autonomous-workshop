...
`<WORKSHOP_RUN>/artifacts/make/r0001/product/cad/veinwake/part_bubble_3.step.py --nozzle 0.4 --report <WORKSHOP_RUN>/artifacts/make/r0001/product/cad/veinwake/measure/rounds/r0002/thickness-bubble_3.md`
