...
`<WORKSHOP_RUN>/artifacts/make/r0001/product/cad/veinwake/part_tooth_2.step.py --nozzle 0.4 --report <WORKSHOP_RUN>/artifacts/make/r0001/product/cad/veinwake/measure/rounds/r0001/thickness-tooth_2.md`
