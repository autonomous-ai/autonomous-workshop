...
`artifacts/make/r0001/product/cybercab/part_end_wheel.stl --nozzle 0.4 --report artifacts/make/r0001/product/cybercab/measure/thickness-end_wheel.md`

artifacts/make/r0001/product/cybercab/part_end_wheel.stl: 5.83 cm3 solid, grid 0.133 mm (252x252x57), 138492 surface samples, grid resolved to 0.067 mm, exact where under the minimum
