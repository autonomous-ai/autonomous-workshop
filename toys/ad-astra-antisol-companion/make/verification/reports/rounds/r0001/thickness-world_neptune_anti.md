...
`<WORKSHOP_RUN>/artifacts/make/r0001/product/cad/part_world_neptune_anti.step.py --nozzle 0.4 --report <WORKSHOP_RUN>/artifacts/make/r0001/product/cad/measure/rounds/r0001/thickness-world_neptune_anti.md`
