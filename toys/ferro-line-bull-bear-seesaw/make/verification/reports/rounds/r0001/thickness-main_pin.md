...
`<WORKSHOP_RUN>/artifacts/make/r0001/product/cad/part_main_pin.step.py --nozzle 0.4 --report <WORKSHOP_RUN>/artifacts/make/r0001/product/cad/measure/rounds/r0001/thickness-main_pin.md`
