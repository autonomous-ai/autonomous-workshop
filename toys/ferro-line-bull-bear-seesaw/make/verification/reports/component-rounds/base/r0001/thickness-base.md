...
part_base.step.py: 48.63 cm3 solid, grid 0.251 mm (442x283x84), 293412 surface samples, thickness resolved to 0.126 mm

| check | status | detail |
|---|---|---|
| wall >= 0.80 mm (+/-0.13) | PASS | 0.0% of surface below (0 of 293412 samples) |
| thickness distribution | PASS | median 6.03 mm, p95 69.89 mm, max 124.20 mm |
| hollowable at 1.20 mm wall | WARN | 26.22 of 48.63 cm3 (54%) in 1 pocket(s) |
