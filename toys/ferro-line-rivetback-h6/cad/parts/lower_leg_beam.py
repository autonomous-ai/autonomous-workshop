...
def build():
    ...
    joint_blocks = (
        Pos(1.5, 0, 0) * Box(3.0, lower_width, 12.0, align=(Align.CENTER, Align.CENTER, Align.CENTER))
        + Pos(lower_dx - 1.5, 0, lower_dz) * Box(3.0, lower_width, 12.0, align=(Align.CENTER, Align.CENTER, Align.CENTER))
    )
    ...
    return color_part((body + joint_blocks + tenon + foot_peg) - armor_slots, "lower_leg_beam", black_rgb)
