...
`project/part_follower_keeper.stl --nozzle 0.4 --report project/measure/thickness-follower_keeper.md`

project/part_follower_keeper.stl: 0.69 cm3 solid, grid 0.133 mm (335x110x74), 64432 surface samples, thickness resolved to 0.067 mm
