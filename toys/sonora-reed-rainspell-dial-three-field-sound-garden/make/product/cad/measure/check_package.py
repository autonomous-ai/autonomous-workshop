...
def main() -> None:
    ...
    audit = load("cad/measure/acoustic_geometry.json")
    ...
    assert sha256(PRODUCT_ROOT / "cad/rainspell_dial.step") == assembly["step_sha256"]
    assert sha256(PRODUCT_ROOT / "cad/rainspell_dial.stl") == assembly["stl_sha256"]
