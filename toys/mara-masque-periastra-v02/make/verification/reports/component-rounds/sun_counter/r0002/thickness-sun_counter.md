...
`<WORKSHOP_RUN>/artifacts/make/r0001/product/cad/part_sun_counter.step.py --nozzle 0.4 --report <WORKSHOP_RUN>/artifacts/make/r0001/product/cad/measure/component-rounds/sun_counter/r0002/thickness-sun_counter.md`
