...
`6c517a7e675ff1aa9383758c9c2f9c003a813077ca3df2c1e454d571304c9b1d`.
...
| `part_panel_northeast.step` | `8830947ee25c05b5` | `6e271632bc346752` | 1 line differs, NEXT_ASSEMBLY_USAGE_OCCURRENCE: an exporter occurrence counter, no geometry. Every other line matches the archive copy, checked here rather than asserted |
| `part_panel_northwest.step` | `29a2bed6521318c3` | `a9a369260291a15f` | 1 line differs, NEXT_ASSEMBLY_USAGE_OCCURRENCE: an exporter occurrence counter, no geometry. Every other line matches the archive copy, checked here rather than asserted |
| `part_panel_southeast.step` | `10ea84f01d22cc9e` | `2ff52ee45be65ceb` | 1 line differs, NEXT_ASSEMBLY_USAGE_OCCURRENCE: an exporter occurrence counter, no geometry. Every other line matches the archive copy, checked here rather than asserted |
| `part_panel_southwest.step` | `44e00649f2822a7a` | `e17f8bca4f8a1be8` | 1 line differs, NEXT_ASSEMBLY_USAGE_OCCURRENCE: an exporter occurrence counter, no geometry. Every other line matches the archive copy, checked here rather than asserted |
...
- **`part_world_saturn_sol.step`, `part_world_saturn_anti.step` are byte-identical too.**
...
- **No printed geometry changed shape.** Exactly 2 printed parts
  corrected -- `part_world_saturn_sol`, `part_world_saturn_anti` -- and the correction is a colour boundary, not a
  solid.
