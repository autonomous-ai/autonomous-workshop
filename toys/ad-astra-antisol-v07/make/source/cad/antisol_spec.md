...
- **Markings** — flush colour inlays reaching 1.20 mm into the globe, described [assumed]
  ...
  minimum outline width hold from Mercury to Jupiter. **Three of the eight
  worlds are described entirely by latitude, longitude and angular size** —
  Neptune, Uranus and Saturn — because a union of round patches or a belt of
  ...
  **Jupiter is the eighth and is described both ways**, and that split is
  ...
  Neptune's dark spot stays round for that reason. Jupiter's does not: the real
...
| filament | used for |
|---|---|
| `white` | Sol disc, Anti-Sol numeral, Mercury Caloris floor, Mars caps, Earth ice, Uranus band, Neptune streaks, Saturn ring and northern cap |
