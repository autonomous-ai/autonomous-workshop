# How far apart the two pieces of each pair read -- BEFORE this correction

**This run measures the set as it was.**
`markings.MAP_MIRRORED_WORLDS` was emptied before building, so
every Anti-Sol piece carries its map at the same longitudes as
its Sol twin and the only thing separating a pair is the lean.
It is here to be laid beside the corrected run.
...
|---|---:|---|---|---:|---:|
| mercury | 13.78 | hero | 5 / 5 | 0.005 | 2.557 |
| mercury | 13.78 | state sheet | 5 / 5 | 0.004 | 2.833 |
| mars | 14.72 | hero | 5 / 6 | 4.217 | 4.668 |
| mars | 14.72 | state sheet | 5 / 5 | 3.875 | 3.885 |
| venus | 16.53 | hero | 3 / 3 | 0.528 | 4.900 |
| venus | 16.53 | state sheet | 3 / 4 | 1.451 | 4.518 |
...
|---|---:|---:|---:|---|
| mercury | 0.03 | 0.06 | 0.004 mm (0% of the globe radius) | **one object photographed twice** |
| mars | 25.19 | 50.38 | 3.875 mm (53% of the globe radius) | two different objects |
| venus | 177.36 | 5.28 | 0.528 mm (6% of the globe radius) | **one object photographed twice** |
