...
def main() -> int:
    ...
    if failures:
        ...
        mirrored = len(MAP_MIRRORED_WORLDS)
        print("All sixteen cases behave as they must. %d return the"
              % (16 - mirrored))
        print("untouched table itself; the %d mirrored ones return the same"
              % mirrored)
