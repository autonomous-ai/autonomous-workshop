...
`<WORKSHOP_RUN>/artifacts/make/r0001/product/cad/part_panel_southwest.step.py --nozzle 0.4 --report <WORKSHOP_RUN>/artifacts/make/r0001/product/cad/measure/rounds/r0003/thickness-panel_southwest.md`
