...
`<WORKSHOP_RUN>/artifacts/make/r0001/product/cad/part_panel_northeast.step.py --nozzle 0.4 --report <WORKSHOP_RUN>/artifacts/make/r0001/product/cad/measure/component-rounds/panel_northeast/r0004/thickness-panel_northeast.md`
