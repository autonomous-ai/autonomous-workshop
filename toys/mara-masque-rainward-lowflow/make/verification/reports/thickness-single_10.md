...
The matching current-run check printed the following result. Its measured report content is identical to this final report; only command paths differ. Source: `rounds/r0001/thickness-single_10.log` (SHA256 `d138c62068b82388f8413c8a967e2e62ee50e2ee01a84f41b7883971cb4ef362`).
