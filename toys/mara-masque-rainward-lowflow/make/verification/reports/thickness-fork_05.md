...
The matching current-run check printed the following result. Its measured report content is identical to this final report; only command paths differ. Source: `rounds/r0001/thickness-fork_05.log` (SHA256 `b5e4f2db5d27326c2c7cb715b7ebd07cd0b9ba4a7b01010951a247b73da946d0`).
