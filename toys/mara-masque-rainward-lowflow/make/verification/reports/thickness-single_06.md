...
The matching current-run check printed the following result. Its measured report content is identical to this final report; only command paths differ. Source: `rounds/r0001/thickness-single_06.log` (SHA256 `a21fd09bcc37e57cecaad41fcd8983779b494aef87b67797ae0bc699db7fb7ba`).
