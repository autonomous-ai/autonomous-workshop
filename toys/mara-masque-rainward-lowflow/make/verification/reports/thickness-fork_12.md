...
The matching current-run check printed the following result. Its measured report content is identical to this final report; only command paths differ. Source: `rounds/r0001/thickness-fork_12.log` (SHA256 `367db38b8e98f06741a0a05b219bbd7d434870f356b01aca51fb1a1ee72d36d2`).
