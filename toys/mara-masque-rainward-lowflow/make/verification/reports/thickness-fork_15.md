...
The matching current-run check printed the following result. Its measured report content is identical to this final report; only command paths differ. Source: `rounds/r0001/thickness-fork_15.log` (SHA256 `2945973a971fadba4ac49105170e3cc56628636edfb5463ab3b1221fb8046382`).
