...
The matching current-run check printed the following result. Its measured report content is identical to this final report; only command paths differ. Source: `rounds/r0001/thickness-fork_09.log` (SHA256 `cd8497b48a4164f8fd674f28eb3a49566ae4c819b76a813d34d157ac82c40d21`).
