...
The matching current-run check printed the following result. Its measured report content is identical to this final report; only command paths differ. Source: `rounds/r0001/thickness-fork_03.log` (SHA256 `8d04de2e862176901ab3eebff0eccf5496176101137536f2cd6b5343bcb9ccf3`).
