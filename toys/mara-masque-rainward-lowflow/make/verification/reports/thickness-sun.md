...
The matching current-run check printed the following result. Its measured report content is identical to this final report; only command paths differ. Source: `rounds/r0001/thickness-sun.log` (SHA256 `e366707dc33fc62260eaab7c13cd998adb3e9eac5a907404366ab4128ad96a6a`).
