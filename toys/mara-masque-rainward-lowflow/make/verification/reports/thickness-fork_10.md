...
The matching current-run check printed the following result. Its measured report content is identical to this final report; only command paths differ. Source: `rounds/r0001/thickness-fork_10.log` (SHA256 `a3aa6e8393dc5046cff431dd160732d442ab65da5f0e376df30c5db80cb86a7b`).
