...
def check_corona():
    ...
    # every tongue leans the same way, and the hero crest leans with them
    assert P.CORONA_LEAN_DEG > 0.0 and P.CORONA_LEAN_FRAC > 0.0
    ...
    assert P.TILE_BAY_OUTER < P.PITCH / 2.0 - 3.0, "a bay reaches a counter"
