...
part_lane_04_cocoa_brown.step.py: 2.22 cm3 solid, grid 0.133 mm (459x323x35), 123609 surface samples, thickness resolved to 0.067 mm

| check | status | detail |
|---|---|---|
| wall >= 0.80 mm (+/-0.07) | PASS | 0.0% of surface below (294 of 123609 samples); thinnest 0.13 mm at (70.1, 53.1, 0.1) in 2 region(s); no region is a wall, 2 taper(s) at feature edges (0.00% of surface, budget 2%); 3 more within measurement error of the limit |
...
|---|---|---|---|---|---|---|---|
| 1 | taper | 0.13 mm | (70.1, 53.1, 0.1) | 158 | 0.0 | 0.7 | 0.06 |
| 2 | taper | 0.13 mm | (80.7, 34.0, 0.1) | 136 | 0.0 | 0.6 | 0.03 |
