...
def audit():
    ...
    report = {
        ...
        "note": ("Support is measured against one tile's flat top face only. A "
                 ...
                 "shortfall below 1.0 and is reported, never hidden. The skirt "
                 "troughs that cut inside radius 90 sit on lane boundaries, so "
                 "the rim stays full under every outermost counter."),
    }
    report["pass"] = bool(
