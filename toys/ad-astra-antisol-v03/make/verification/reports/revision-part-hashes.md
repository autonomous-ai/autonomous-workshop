...
`b664128c04bb3af93475d62fb0edfadb6b888cd25ce669e41b56d50708308588`.
...
| `part_panel_northeast.step` | `7845440315cf469f` | `6b72fb6b87c4d2f2` | 1 line differs, NEXT_ASSEMBLY_USAGE_OCCURRENCE: an exporter occurrence counter, no geometry. Every other line matches the archive copy, checked here rather than asserted |
| `part_panel_northwest.step` | `342dafd88f96eeb9` | `af46270fd67bb4b0` | 1 line differs, NEXT_ASSEMBLY_USAGE_OCCURRENCE: an exporter occurrence counter, no geometry. Every other line matches the archive copy, checked here rather than asserted |
| `part_panel_southeast.step` | `5383d3d6e41e3385` | `00e504d06c80d87c` | 1 line differs, NEXT_ASSEMBLY_USAGE_OCCURRENCE: an exporter occurrence counter, no geometry. Every other line matches the archive copy, checked here rather than asserted |
| `part_panel_southwest.step` | `0da504684085ccc2` | `02586c970402827d` | 1 line differs, NEXT_ASSEMBLY_USAGE_OCCURRENCE: an exporter occurrence counter, no geometry. Every other line matches the archive copy, checked here rather than asserted |
...
- **`part_world_mars_sol.step`, `part_world_mars_anti.step` are byte-identical too.**
...
- **No printed geometry changed shape.** Exactly 2 printed parts
  corrected -- `part_world_mars_sol`, `part_world_mars_anti` -- and the correction is a colour boundary, not a
  solid.
...
time of the run, so all 182 differ between any two runs whatever the
