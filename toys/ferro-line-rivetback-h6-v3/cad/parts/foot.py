...
def build():
    profile = [
        (0, 0), (foot_length - 1.0, 0), (foot_length, 1.2),
        (foot_length - 5.0, 4.5), (6.0, foot_height), (0, 6.5),
    ]
    ...
    socket = Pos(1.25, -1.0, foot_socket_z) * Box(5.5, 7.5, 3.5, align=(Align.CENTER, Align.CENTER, Align.CENTER))
    return color_part((body + heel) - socket, "foot", black_rgb)
