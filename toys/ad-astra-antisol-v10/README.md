...
![Antisol Poseidon](make/verification/renders/iso.png)

Jungle Chess played with the solar system. Every piece is a planet, and a planet's size on the board is the fifth root of its real measured diameter, so rank is something you can see rather than learn: Mercury is the smallest world in play and Jupiter the largest, and the traditional rules are followed exactly as written. Matter faces antimatter. One army's worlds lean their poles one way and the other army's lean the other, by each planet's own true axial tilt, and the bases say it again in white against black. Four of the eight wear a real map -- Earth its coastlines, Mars its dark continents, Mercury its smooth plains with the Caloris basin in them, and Venus the radar surface no eye has seen. The other four wear their weather. Neptune is the world this edition changes, and the change is unusual enough to say at the top: nothing was wrong with it. The owner prefers the older drawing. Neptune wore three closed white bands of latitude; the edition before last replaced them with eight short tapered cloud streaks and a bright companion wisp, and argued it from Neptune's own photograph, which shows clouds that are short and do not ring the planet. That case was measured and reviewed blind. The owner has looked at both and wants the three bands back, so they are back: white, at 46 to 41 degrees south, 11 to 15 north and 30 to 33 north -- the narrowest band system in the box. The argument they overruled is kept word for word in the source that draws this world, under a heading saying what happened to it, so a reader can see both. The Great Dark Spot does not move, and that was checked on the built solids rather than assumed. The bright cloud beside it is gone with the streaks, which is a loss and is recorded as one. Both Neptune pieces come out byte-for-byte identical to the last edition's, because a marking here partitions a globe without moving its surface. Nothing else in the set changed.
...
**Input:** the frozen Wish, eligible Inventor roster with each bound Taste/skill bundle, and the product blueprint. **Output:** **Ad Astra** was selected and produced **Antisol Poseidon** — Jungle Chess played with the solar system. Every piece is a planet, and a planet's size on the board is the fifth root of its real measured diameter, so rank is something you can see rather than learn: Mercury is the smallest world in play and Jupiter the largest, and the traditional rules are followed exactly as written. Matter faces antimatter. One army's worlds lean their poles one way and the other army's lean the other, by each planet's own true axial tilt, and the bases say it again in white against black. Four of the eight wear a real map -- Earth its coastlines, Mars its dark continents, Mercury its smooth plains with the Caloris basin in them, and Venus the radar surface no eye has seen. The other four wear their weather. Neptune is the world this edition changes, and the change is unusual enough to say at the top: nothing was wrong with it. The owner prefers the older drawing. Neptune wore three closed white bands of latitude; the edition before last replaced them with eight short tapered cloud streaks and a bright companion wisp, and argued it from Neptune's own photograph, which shows clouds that are short and do not ring the planet. That case was measured and reviewed blind. The owner has looked at both and wants the three bands back, so they are back: white, at 46 to 41 degrees south, 11 to 15 north and 30 to 33 north -- the narrowest band system in the box. The argument they overruled is kept word for word in the source that draws this world, under a heading saying what happened to it, so a reader can see both. The Great Dark Spot does not move, and that was checked on the built solids rather than assumed. The bright cloud beside it is gone with the streaks, which is a loss and is recorded as one. Both Neptune pieces come out byte-for-byte identical to the last edition's, because a marking here partitions a globe without moving its surface. Nothing else in the set changed. **Concept parts:** Board panel southwest, Board panel southeast, Board panel northwest, Board panel northeast, Asteroid belt tile, Sol star, Sol prominences, Anti-Sol star, Anti-Sol prominences, Sol corona cell, Anti-Sol corona cell, Orbit tray, Orbit tray, Sol disc, Sol rank numeral, Anti-Sol disc, Anti-Sol rank numeral, Mercury globe, Mercury smooth plains, Mercury Caloris rim, Mercury Caloris floor, Mars globe, Mars albedo, Mars north cap, Venus globe, Venus highlands, Earth globe, Earth land, Earth dryland, Earth ice, Neptune globe, Neptune spot, Neptune bands, Uranus globe, Uranus north polar hood, Uranus south polar hood, Uranus ring, Saturn globe, Saturn light bands, Saturn dark band, Saturn north cap, Saturn ring, Jupiter globe, Jupiter belts, Jupiter spot, Jupiter zones, Jupiter spot collar, Venus lowland plains. The complete compact concept is in [make/invented.json](make/invented.json). Spark has no separate Invent Goal; the accepted Inventor assignment and compact Make concept are preserved separately.

### 3. Make — turn the concept into exact product bytes

**Input:** the accepted concept, selected Inventor identity/Taste, blueprint, and any bounded revision evidence. **Output:** Jungle Chess played with the solar system. Every piece is a planet, and a planet's size on the board is the fifth root of its real measured diameter, so rank is something you can see rather than learn: Mercury is the smallest world in play and Jupiter the largest, and the traditional rules are followed exactly as written. Matter faces antimatter. One army's worlds lean their poles one way and the other army's lean the other, by each planet's own true axial tilt, and the bases say it again in white against black. Four of the eight wear a real map -- Earth its coastlines, Mars its dark continents, Mercury its smooth plains with the Caloris basin in them, and Venus the radar surface no eye has seen. The other four wear their weather. Neptune is the world this edition changes, and the change is unusual enough to say at the top: nothing was wrong with it. The owner prefers the older drawing. Neptune wore three closed white bands of latitude; the edition before last replaced them with eight short tapered cloud streaks and a bright companion wisp, and argued it from Neptune's own photograph, which shows clouds that are short and do not ring the planet. That case was measured and reviewed blind. The owner has looked at both and wants the three bands back, so they are back: white, at 46 to 41 degrees south, 11 to 15 north and 30 to 33 north -- the narrowest band system in the box. The argument they overruled is kept word for word in the source that draws this world, under a heading saying what happened to it, so a reader can see both. The Great Dark Spot does not move, and that was checked on the built solids rather than assumed. The bright cloud beside it is gone with the streaks, which is a loss and is recorded as one. Both Neptune pieces come out byte-for-byte identical to the last edition's, because a marking here partitions a globe without moving its surface. Nothing else in the set changed. The sealed snapshot contains 26 STEP and 36 product render PNGs, together with [CAD source](make/source/), [models](make/models/), and [deterministic verification](make/verification/). [The Made contract](make/made.json) binds those exact bytes.
...
| Wish to verified publication | 3h 8m 3s (2026-09-20T03:35:59Z to 2026-09-20T06:44:02+00:00) |
