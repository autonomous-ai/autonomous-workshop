...
`.cad-host-files.yfkkNW/assembled.stl --nozzle 0.4 --report .cad-host-files.yfkkNW/measure/thickness-assembled.md`

.cad-host-files.yfkkNW/assembled.stl: 52.80 cm3 solid, grid 0.228 mm (363x373x84), 284629 surface samples, thickness resolved to 0.114 mm
