...
`<WORKSHOP_RUN>/artifacts/make/r0001/product/gear_vortex/part_sun.step.py --nozzle 0.4 --report <WORKSHOP_RUN>/artifacts/make/r0001/product/gear_vortex/measure/rounds/r0001/thickness-sun.md`
