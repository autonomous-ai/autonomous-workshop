...
`<WORKSHOP_RUN>/artifacts/make/r0001/product/cad/part_single_09.step.py --nozzle 0.4 --report <WORKSHOP_RUN>/artifacts/make/r0001/product/cad/measure/rounds/r0001/thickness-single_09.md`

part_single_09.step.py: 0.24 cm3 solid, grid 0.133 mm (95x65x35), 13478 surface samples, thickness resolved to 0.067 mm
