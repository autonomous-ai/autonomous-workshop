...
`<WORKSHOP_RUN>/artifacts/make/r0001/product/cad/part_single_01.step.py --nozzle 0.4 --report <WORKSHOP_RUN>/artifacts/make/r0001/product/cad/measure/rounds/r0003/thickness-single_01.md`

part_single_01.step.py: 0.20 cm3 solid, grid 0.133 mm (95x65x35), 12243 surface samples, thickness resolved to 0.067 mm
