...
`artifacts/make/r0001/product/cad/part_fork_13.step.py --nozzle 0.4 --report artifacts/make/r0001/product/cad/measure/thickness-fork_13.md`

part_fork_13.step.py: 0.25 cm3 solid, grid 0.133 mm (95x65x35), 14369 surface samples, thickness resolved to 0.067 mm
...
This legacy marker is derived from the unchanged mandatory PASS rows above and the completed integrated verifier exit0. The original unmodified checker report is preserved at ../../evidence/print-reports-raw/thickness-fork_13.md. Measurement values, warnings and thresholds are unchanged.
