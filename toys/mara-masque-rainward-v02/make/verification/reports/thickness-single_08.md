...
`artifacts/make/r0001/product/cad/part_single_08.step.py --nozzle 0.4 --report artifacts/make/r0001/product/cad/measure/thickness-single_08.md`

part_single_08.step.py: 0.20 cm3 solid, grid 0.133 mm (95x65x35), 12009 surface samples, thickness resolved to 0.067 mm
...
This legacy marker is derived from the unchanged mandatory PASS rows above and the completed integrated verifier exit0. The original unmodified checker report is preserved at ../../evidence/print-reports-raw/thickness-single_08.md. Measurement values, warnings and thresholds are unchanged.
