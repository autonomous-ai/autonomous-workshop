...
This legacy marker is derived from the unchanged mandatory PASS rows above and the completed integrated verifier exit0. The original unmodified checker report is preserved at ../../evidence/print-reports-raw/thickness-die_2.md. Measurement values, warnings and thresholds are unchanged.
