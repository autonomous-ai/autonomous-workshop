...
DECK, BAR_TOP, CREST_TOP, BAR_R = 16.0, 28.0, 28.0, 24.0
...
def sun():
    ...
    # The entire unobstructed plateau carries the preserved28mm maximum height.
    # Both historical crest blocks removed; deck/lanes/rays remain exact.
...
def assembly(state='setup'):
    ...
    return Compound(label='rainward_flow',children=pieces)
