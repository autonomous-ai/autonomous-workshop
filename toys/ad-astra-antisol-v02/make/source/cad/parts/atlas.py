...
Every other world in this set wears an albedo map, a cloud pattern or a band
system, and a union of round blobs is what those actually are.  Earth is the
one world whose real surface has an outline a player already knows by heart,
so Earth alone is drawn from coastlines.
