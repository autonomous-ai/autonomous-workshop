...
# Preserved illustration geometry: the hit victim travels the same 80 mm.
BAR_HIT_R = 85.0 - sqrt(80.0 ** 2 - (P.BAR_TOP - P.LANE_TOP) ** 2)
...
def assembly(state="setup", neutral=False):
    ...
    return Compound(label="rainward_corona", children=children)
