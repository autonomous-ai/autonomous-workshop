"""The Sun body: disc, corona of 32 separate flames, 24 lane pockets, bar, markers."""
...
def corona():
    """The thirty-two flames, each rooted on its own arc of the disc edge.

    Each carries its own handedness: `params.CORONA_SENSE` mirrors fourteen of
    them about their own radial midline, which changes nothing about the root,
    the turn magnitude, the ramp or the print pose.
    """
