...
`<WORKSHOP_RUN>/artifacts/make/r0001/product/cad/part_single_comet.step.py --nozzle 0.4 --report <WORKSHOP_RUN>/artifacts/make/r0001/product/cad/measure/rounds/r0001/thickness-single_comet.md`
