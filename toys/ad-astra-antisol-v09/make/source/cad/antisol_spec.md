# Antisol Ouranos — design contract
...
- **Markings** — flush colour inlays reaching 1.20 mm into the globe, described [assumed]
  ...
  northern cap reuses. Saturn is described both ways, and since this revision so is
...
| filament | used for |
|---|---|
| `white` | Sol disc, Anti-Sol numeral, Mercury Caloris floor, Mars caps, Earth ice, Neptune cloud streaks and the dark spot's bright companion, Saturn ring and northern cap |
