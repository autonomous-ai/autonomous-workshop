...
def main() -> int:
    ...
    print()
    print("**The two hoods and the ring are identical to %g mm3 on both armies.**"
          % TOLERANCE)
    print("That is the answer this correction needed: a hood is a flush inlay and")
    print("a ring is added material, and neither depends on which way the piece")
    print("leans. The three bodies that do differ are the three the set means to")
    print("differ, and they differ by the draft rather than by the marking.")
    print()
