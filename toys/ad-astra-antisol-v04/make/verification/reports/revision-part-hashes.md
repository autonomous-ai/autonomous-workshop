...
`0ef71a5982ddffbac40e82df14e6b6f01592543e7a9bdfafb29c655f18d65e70`.
...
| `part_panel_northeast.step` | `87a9163e13daa289` | `671b7515765c80e0` | 1 line differs, NEXT_ASSEMBLY_USAGE_OCCURRENCE: an exporter occurrence counter, no geometry. Every other line matches the archive copy, checked here rather than asserted |
| `part_panel_northwest.step` | `9b92e07df10c295d` | `f2b468af1483a03d` | 1 line differs, NEXT_ASSEMBLY_USAGE_OCCURRENCE: an exporter occurrence counter, no geometry. Every other line matches the archive copy, checked here rather than asserted |
| `part_panel_southeast.step` | `8984eee306a6755c` | `7af259991ff70041` | 1 line differs, NEXT_ASSEMBLY_USAGE_OCCURRENCE: an exporter occurrence counter, no geometry. Every other line matches the archive copy, checked here rather than asserted |
| `part_panel_southwest.step` | `53600a72bac6c935` | `97990d97c69e846a` | 1 line differs, NEXT_ASSEMBLY_USAGE_OCCURRENCE: an exporter occurrence counter, no geometry. Every other line matches the archive copy, checked here rather than asserted |
...
- **`part_world_mercury_sol.step`, `part_world_mercury_anti.step` are byte-identical too.**
...
- **No printed geometry changed shape.** Exactly 2 printed parts
  corrected -- `part_world_mercury_sol`, `part_world_mercury_anti` -- and the correction is a colour boundary, not a
  solid.
...
time of the run, so all 186 differ between any two runs whatever the
