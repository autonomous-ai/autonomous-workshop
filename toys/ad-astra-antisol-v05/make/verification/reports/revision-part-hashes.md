...
`5d0ca9acc9744fb562a0326136a56311fb1c9e041a862cbd0cff1a093054e240`.
...
| `part_panel_northeast.step` | `671b7515765c80e0` | `6b72fb6b87c4d2f2` | 1 line differs, NEXT_ASSEMBLY_USAGE_OCCURRENCE: an exporter occurrence counter, no geometry. Every other line matches the archive copy, checked here rather than asserted |
| `part_panel_northwest.step` | `f2b468af1483a03d` | `af46270fd67bb4b0` | 1 line differs, NEXT_ASSEMBLY_USAGE_OCCURRENCE: an exporter occurrence counter, no geometry. Every other line matches the archive copy, checked here rather than asserted |
| `part_panel_southeast.step` | `7af259991ff70041` | `00e504d06c80d87c` | 1 line differs, NEXT_ASSEMBLY_USAGE_OCCURRENCE: an exporter occurrence counter, no geometry. Every other line matches the archive copy, checked here rather than asserted |
| `part_panel_southwest.step` | `97990d97c69e846a` | `02586c970402827d` | 1 line differs, NEXT_ASSEMBLY_USAGE_OCCURRENCE: an exporter occurrence counter, no geometry. Every other line matches the archive copy, checked here rather than asserted |
...
- **`part_world_venus_sol.step`, `part_world_venus_anti.step` are byte-identical too.**
...
- **No printed geometry changed shape.** Exactly 2 printed parts
  corrected -- `part_world_venus_sol`, `part_world_venus_anti` -- and the correction is a colour boundary, not a
  solid.
...
time of the run, so all 204 differ between any two runs whatever the
