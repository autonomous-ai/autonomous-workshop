...
def build_gargoyle():
    ...
    wing_l = Pos(5, -29, 46) * Rot(8, 20, 18) * Sphere(1).scale((30, 19, 8))
    wing_r = Pos(5, 29, 46) * Rot(-8, 20, -18) * Sphere(1).scale((30, 19, 8))
    ...
    throat = Pos(-30, 0, 22.5) * Box(50, 30, THROAT_CLEARANCE,
                                   align=(Align.CENTER, Align.CENTER, Align.CENTER))
    shape = shape - throat
    ...
    shape = shape.fuse(dorsal_saddle)
