...
`artifacts/make/r0001/product/cad/part_G.step.py --angle 45.0 --report artifacts/make/r0001/product/cad/measure/overhang-G.md`

part_G.step.py: 115.0 cm2 of surface, grid 0.400 mm, 623 unsupported samples over 6 region(s)

| check | status | detail |
|---|---|---|
| no face under 45 deg needs support | PASS | 9.3% of the surface faces down that steeply; 0 region(s) need support, 6 bridge, 0 below 1 mm2 |
...
| 4 | bridge | 14.1 | (21.9, 11.2, 50.7) | 3.0 | 20.0 |
| 5 | bridge | 14.1 | (21.9, 11.1, 73.7) | 3.0 | 20.0 |
| 6 | bridge | 14.1 | (9.7, 11.1, 73.7) | 2.9 | 20.0 |
