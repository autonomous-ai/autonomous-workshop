...
`<WORKSHOP_RUN>/artifacts/make/r0001/product/cad/part_northwest_panel.step.py --nozzle 0.4 --report <WORKSHOP_RUN>/artifacts/make/r0001/product/cad/measure/rounds/r0001/thickness-northwest_panel.md`
