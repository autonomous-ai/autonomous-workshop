...
`<WORKSHOP_RUN>/artifacts/make/r0001/product/cad/part_circle_crater_moon.step.py --nozzle 0.4 --report <WORKSHOP_RUN>/artifacts/make/r0001/product/cad/measure/rounds/r0001/thickness-circle_crater_moon.md`
