...
`<WORKSHOP_RUN>/artifacts/make/r0001/product/cad/part_circle_twin_tail_comet.step.py --nozzle 0.4 --report <WORKSHOP_RUN>/artifacts/make/r0001/product/cad/measure/rounds/r0001/thickness-circle_twin_tail_comet.md`
