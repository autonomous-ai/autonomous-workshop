...
`<WORKSHOP_RUN>/artifacts/make/r0001/product/cad/part_square_pulsar.step.py --nozzle 0.4 --report <WORKSHOP_RUN>/artifacts/make/r0001/product/cad/measure/component-rounds/square_pulsar/r0001/thickness-square_pulsar.md`
