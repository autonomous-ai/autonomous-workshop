...
`<WORKSHOP_RUN>/artifacts/make/r0001/product/cad/part_southwest_panel.step.py --nozzle 0.4 --report <WORKSHOP_RUN>/artifacts/make/r0001/product/cad/measure/component-rounds/southwest_panel/r0002/thickness-southwest_panel.md`
