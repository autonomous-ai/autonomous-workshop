...
`<WORKSHOP_RUN>/artifacts/make/r0001/product/mintfin/part_tail_right.step.py --nozzle 0.4 --report <WORKSHOP_RUN>/artifacts/make/r0001/product/mintfin/measure/rounds/r0002/thickness-tail_right.md`
