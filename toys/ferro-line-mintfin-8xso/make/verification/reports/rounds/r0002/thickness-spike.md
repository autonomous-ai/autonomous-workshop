...
`<WORKSHOP_RUN>/artifacts/make/r0001/product/mintfin/part_spike.step.py --nozzle 0.4 --report <WORKSHOP_RUN>/artifacts/make/r0001/product/mintfin/measure/rounds/r0002/thickness-spike.md`
