...
`<WORKSHOP_RUN>/artifacts/make/r0001/product/mintfin/part_horn_middle.step.py --nozzle 0.4 --report <WORKSHOP_RUN>/artifacts/make/r0001/product/mintfin/measure/rounds/r0002/thickness-horn_middle.md`
