...
`f9e2d1e1faa386e23e2fc4d92f0184c1a1cd2b3014613eb10b22f9c29b0624c7`.
...
| `part_panel_northeast.step` | `71ff8f6f63f1383a` | `8830947ee25c05b5` | 1 line differs, NEXT_ASSEMBLY_USAGE_OCCURRENCE: an exporter occurrence counter, no geometry. Every other line matches the archive copy, checked here rather than asserted |
| `part_panel_northwest.step` | `321bdf7ab3b0f8c8` | `29a2bed6521318c3` | 1 line differs, NEXT_ASSEMBLY_USAGE_OCCURRENCE: an exporter occurrence counter, no geometry. Every other line matches the archive copy, checked here rather than asserted |
| `part_panel_southeast.step` | `5c1634df57480d4a` | `10ea84f01d22cc9e` | 1 line differs, NEXT_ASSEMBLY_USAGE_OCCURRENCE: an exporter occurrence counter, no geometry. Every other line matches the archive copy, checked here rather than asserted |
| `part_panel_southwest.step` | `78246ddd0f3faaf3` | `44e00649f2822a7a` | 1 line differs, NEXT_ASSEMBLY_USAGE_OCCURRENCE: an exporter occurrence counter, no geometry. Every other line matches the archive copy, checked here rather than asserted |
...
- **`part_world_jupiter_sol.step`, `part_world_jupiter_anti.step` are byte-identical too.**
...
- **No printed geometry changed shape.** Exactly 2 printed parts
  corrected -- `part_world_jupiter_sol`, `part_world_jupiter_anti` -- and the correction is a colour boundary, not a
  solid.
...
time of the run, so all 216 differ between any two runs whatever the
