...
Mean meridian C = -49.9875 degrees.

| ring | frame | Sol centroid | Anti centroid | change | Sol vertices over +0.30 | Anti vertices over +0.30 |
|---|---|---:|---:|---:|---:|---:|
| `plains` ring 1 | hero | +0.309 | +0.456 | +0.146 | 10 of 21 | 12 of 21 |
| `plains` ring 1 | state sheet | +0.481 | +0.352 | -0.128 | 12 of 21 | 10 of 21 |
| `plains` ring 2 | hero | -0.178 | -0.020 | +0.159 | 0 of 19 | 3 of 19 |
| `plains` ring 2 | state sheet | +0.013 | -0.126 | -0.139 | 3 of 19 | 0 of 19 |
| `plains` ring 3 | hero | -0.992 | -0.961 | +0.032 | 0 of 16 | 0 of 16 |
| `plains` ring 3 | state sheet | -0.928 | -0.956 | -0.028 | 0 of 16 | 0 of 16 |
| `plains` ring 4 | hero | -0.947 | -0.971 | -0.024 | 0 of 14 | 0 of 14 |
| `plains` ring 4 | state sheet | -0.891 | -0.870 | +0.021 | 0 of 14 | 0 of 14 |
| `plains` ring 5 | hero | +0.108 | -0.019 | -0.127 | 6 of 20 | 4 of 20 |
| `plains` ring 5 | state sheet | +0.132 | +0.242 | +0.110 | 7 of 20 | 9 of 20 |
| `plains` ring 6 | hero | +0.564 | +0.431 | -0.133 | 14 of 15 | 9 of 15 |
| `plains` ring 6 | state sheet | +0.362 | +0.479 | +0.117 | 8 of 15 | 11 of 15 |
| `plains` ring 7 | hero | -0.740 | -0.825 | -0.085 | 0 of 12 | 0 of 12 |
| `plains` ring 7 | state sheet | -0.722 | -0.648 | +0.074 | 0 of 12 | 0 of 12 |
| `caloris_rim` ring 1 | hero | +0.987 | +0.987 | -0.000 | 23 of 23 | 23 of 23 |
| `caloris_rim` ring 1 | state sheet | +0.993 | +0.993 | +0.000 | 23 of 23 | 23 of 23 |
| `caloris_floor` ring 1 | hero | +0.987 | +0.987 | -0.000 | 13 of 13 | 13 of 13 |
| `caloris_floor` ring 1 | state sheet | +0.993 | +0.993 | +0.000 | 13 of 13 | 13 of 13 |

### venus

Mean meridian C = -123.8529 degrees.

| ring | frame | Sol centroid | Anti centroid | change | Sol vertices over +0.30 | Anti vertices over +0.30 |
|---|---|---:|---:|---:|---:|---:|
| `highland` ring 1 | hero | +0.756 | +0.731 | -0.025 | 12 of 14 | 12 of 14 |
| `highland` ring 1 | state sheet | +0.825 | +0.605 | -0.220 | 14 of 14 | 10 of 14 |
| `highland` ring 2 | hero | +0.913 | +0.916 | +0.004 | 15 of 15 | 15 of 15 |
| `highland` ring 2 | state sheet | +0.786 | +0.879 | +0.092 | 13 of 15 | 15 of 15 |
| `highland` ring 3 | hero | -0.382 | -0.439 | -0.057 | 0 of 14 | 0 of 14 |
| `highland` ring 3 | state sheet | -0.517 | -0.666 | -0.149 | 0 of 14 | 0 of 14 |
| `highland` ring 4 | hero | -0.812 | -0.798 | +0.013 | 0 of 6 | 0 of 6 |
| `highland` ring 4 | state sheet | -0.902 | -0.720 | +0.182 | 0 of 6 | 0 of 6 |
| `highland` ring 5 | hero | -0.641 | -0.594 | +0.047 | 0 of 6 | 0 of 6 |
| `highland` ring 5 | state sheet | -0.616 | -0.376 | +0.240 | 0 of 6 | 0 of 6 |
| `highland` ring 6 | hero | -0.469 | -0.453 | +0.016 | 0 of 6 | 0 of 6 |
| `highland` ring 6 | state sheet | -0.211 | -0.342 | -0.131 | 0 of 6 | 0 of 6 |
| `highland` ring 7 | hero | -0.342 | -0.281 | +0.061 | 0 of 6 | 0 of 6 |
| `highland` ring 7 | state sheet | -0.226 | -0.009 | +0.217 | 0 of 6 | 0 of 6 |
| `highland` ring 8 | hero | +0.132 | +0.168 | +0.036 | 1 of 8 | 2 of 8 |
| `highland` ring 8 | state sheet | +0.392 | +0.337 | -0.056 | 5 of 8 | 4 of 8 |
| `lowland` ring 1 | hero | +0.367 | +0.337 | -0.030 | 5 of 9 | 5 of 9 |
| `lowland` ring 1 | state sheet | +0.101 | +0.170 | +0.070 | 3 of 9 | 3 of 9 |
| `lowland` ring 2 | hero | -0.994 | -0.995 | -0.001 | 0 of 8 | 0 of 8 |
| `lowland` ring 2 | state sheet | -0.936 | -0.950 | -0.014 | 0 of 8 | 0 of 8 |
| `lowland` ring 3 | hero | -0.276 | -0.244 | +0.033 | 0 of 7 | 0 of 7 |
| `lowland` ring 3 | state sheet | -0.006 | -0.071 | -0.065 | 0 of 7 | 0 of 7 |
...
recognised by -- crosses from one side of the ball to the other
and stays in front of the camera.
...
| world | adjustments that clear | mean clears | best adjustment | its worst margin | taken | its worst margin |
|---|---|---|---:|---:|---:|---:|
| mercury | -1.97 to +4.47 degrees | yes | +1.44 | 0.0898 | +0.00 | 0.0523 |
| venus | +2.26 to +9.55 degrees | **no** | +4.98 | 0.0367 | +5.00 | 0.0365 |
...
its mirrored Anti-Sol twin, at either photographed frame, on
either world. Mercury holds at the plain mean of the two cameras;
Venus holds at the mean moved +5.00 degrees, which is the
adjustment recorded above and the reason it was made.
