...
MARKINGS = {
    ...
    "neptune": [
        ...
        # THE SPOT'S BRIGHT COMPANION, restored by the correction of
        # 2026-09-26: one white outline oval, 10 by 5 degrees of arc, just
        # south of the spot.  Its own key, listed last so nothing above is
        # trimmed by it.  Centred at -33.5, 10 degrees west of the spot's
        # centre: on the spot's meridian a printable gap pushes it under the
        # Sol piece's seat cone, and at "about 8 south" it would overlap the
        # spot.  3.07 degrees of bare blue from the spot's rim, 5 from `b1`.
        # `parts/neptune_atlas.py` gives the arithmetic.  This paragraph
        # supersedes the "companion wisp goes with them" note above.
