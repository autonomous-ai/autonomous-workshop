...
| Sol | `bands` | `white` | 10.945000 | 10.945000 | +0.000000 | flush |
| Sol | `companion` | `white` | 10.945000 | 10.945000 | +0.000000 | flush |
...
| Anti-Sol | `bands` | `white` | 10.945000 | 10.945000 | +0.000000 | flush |
| Anti-Sol | `companion` | `white` | 10.945000 | 10.945000 | +0.000000 | flush |

The greatest any MARKING reaches past the globe's own surface is
**+0.000000 mm** -- every marking body touches the sphere exactly
and none of them crosses it.
...
image, the three white bands included, because it does not
antialias.
...
## Why a reader saw otherwise

Reported blind by the archived build's own critic, from that
build's rendered frames: the markings "are solid
