...
label's whole family, which is why 204 labels carry 224 solids.

- labels published: 204, carrying 224 solids
...
- `uranus_anti_ring_white`
- `uranus_sol_ring_white`

## Changed geometry

- `uranus_anti_globe_cyan` — volume 5323.412371 -> 5542.588301 mm3
- `uranus_sol_globe_cyan` — volume 5323.412384 -> 5542.588301 mm3
