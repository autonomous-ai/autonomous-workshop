...
`<WORKSHOP_RUN>/artifacts/make/r0001/product/cad/part_single_12.step.py --nozzle 0.4 --report <WORKSHOP_RUN>/artifacts/make/r0001/product/cad/measure/rounds/r0002/thickness-single_12.md`

part_single_12.step.py: 0.20 cm3 solid, grid 0.133 mm (95x65x35), 12205 surface samples, thickness resolved to 0.067 mm
