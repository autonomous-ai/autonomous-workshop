...
`<WORKSHOP_RUN>/artifacts/make/r0001/product/cad/part_fork_10.step.py --nozzle 0.4 --report <WORKSHOP_RUN>/artifacts/make/r0001/product/cad/measure/rounds/r0003/thickness-fork_10.md`

part_fork_10.step.py: 0.22 cm3 solid, grid 0.133 mm (95x65x35), 14219 surface samples, thickness resolved to 0.067 mm
