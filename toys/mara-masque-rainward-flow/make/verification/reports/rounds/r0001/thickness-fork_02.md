...
`<WORKSHOP_RUN>/artifacts/make/r0001/product/cad/part_fork_02.step.py --nozzle 0.4 --report <WORKSHOP_RUN>/artifacts/make/r0001/product/cad/measure/rounds/r0001/thickness-fork_02.md`

part_fork_02.step.py: 0.27 cm3 solid, grid 0.133 mm (95x65x35), 15597 surface samples, thickness resolved to 0.067 mm
