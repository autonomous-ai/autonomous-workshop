...
`artifacts/make/r0001/product/cad/part_single_03.step.py --nozzle 0.4 --report artifacts/make/r0001/product/cad/measure/thickness-single_03.md`
...
This legacy marker is derived from the unchanged mandatory PASS rows above and the completed integrated verifier exit0. The original unmodified checker report is preserved at ../../evidence/print-reports-raw/thickness-single_03.md. Measurement values, warnings and thresholds are unchanged.
