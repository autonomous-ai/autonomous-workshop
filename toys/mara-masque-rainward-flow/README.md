...
![Rainward Flow](make/verification/renders/iso.png)

A Sun-shaped backgammon set with flowing plasma counters, an open circular capture bar and dark recessed dice pips.

[View the verified public product page](https://www.autonomous.ai/toys/product/rainward-flow)
...
| Factory | https://www.autonomous.ai/toys/product/rainward-flow |
...
**Input:** the creator's request. **This toy's input:** A Sun-shaped backgammon set with flowing plasma counters, an open circular capture bar and dark recessed dice pips.
...
**Input:** the exact sealed Release package plus host-held Factory authorization; credentials never enter the native session. **Output:** [the public Factory product](https://www.autonomous.ai/toys/product/rainward-flow) and a sanitized, hash-verified [publication readback](publication/PUBLICATION.json).

## Run cost

| Measure | Value |
|---|---|
| Native Manager input tokens | 17,209,932 (measured; 1/1 turns measured) |
| Native Manager cached input tokens | 16,858,112 (measured; 1/1 turns measured) |
| Native Manager uncached input tokens | 351,820 (measured; 1/1 turns measured) |
| Native Manager cache-write input tokens | 0 (measured; 1/1 turns measured) |
| Native Manager output tokens | 47,520 (measured; 1/1 turns measured) |
| Native Manager reasoning output tokens | 16,089 (measured; 1/1 turns measured) |
| Wish to verified publication | 1h 12m 7s (2026-09-11T16:18:06Z to 2026-09-11T17:30:13.272127+00:00) |
...
| Make | 17,209,932 | 16,858,112 | 351,820 | 47,520 | 1 | measured; economics measured |
...
uv run workshop wish --agent codex --model gpt-6-astra --effort medium --workflow spark 'A Sun-shaped backgammon set with flowing plasma counters, an open circular capture bar and dark recessed dice pips.'
```
