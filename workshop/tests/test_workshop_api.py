...
class WorkshopApiTest(unittest.TestCase):
    ...
    def test_canonical_surface_uses_the_short_workshop_story(self):
        self.assertEqual(inventor_workshop.__version__, "0.3.0")
        ...
        self.assertEqual(Stamp.__name__, "Stamp")
        ...
        self.assertEqual(tuple(spec.stages), (
            "make", "inspect", "pack", "send", "parked", "killed"
        ))
        self.assertEqual(Workflow(spec).legal_targets("pack"), ("killed", "send"))
