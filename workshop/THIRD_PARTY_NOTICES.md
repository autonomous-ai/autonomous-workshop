...
The `workshop/src` implementation and `product-to-cad` skill were authored for this
...
`workshop/skills/cad` and `workshop/skills/step-parts` were moved without modification
