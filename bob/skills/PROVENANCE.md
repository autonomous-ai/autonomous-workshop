...
## cad + step-parts — shared from core (vendored 2026-08-22)
- Canonical location: `../../core/skills/{cad,step-parts}`; the paths in this
...
- Release caveat: these tools are not a printability certificate. They do not
  ...
  motion/interference, or physical evidence. Core receipts must bind those
  results before unattended release.
- Update discipline: bump the canonical core snapshot from Peter's repo, never
  by hand edits; record the new commit in `core/skills/PROVENANCE.md`.
