...
import workshop.match.service as manager_module
...
from workshop.contributors.scaffold import scaffold_inventor
from workshop.contributors.taste import load_taste, load_taste_header
