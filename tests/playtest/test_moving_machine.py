...
from workshop.make import canonical_cad_project_sources
...
class WorkshopMovingMachineVerifierTest(unittest.TestCase):
    ...
    def write_product(self):
        ...
        for relative, source in canonical_cad_project_sources(self.action).items():
