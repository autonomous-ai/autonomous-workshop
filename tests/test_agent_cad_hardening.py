...
from inventor_workshop.jobs import Made, PlaytestContext, WaitingFor
from inventor_workshop.make import Wish
from inventor_workshop.taste import load_taste
from inventor_workshop.toys import ToyBlueprint
from tests.test_agent_make import make_action
...
class AgentCadHardeningTest(unittest.TestCase):
    ...
    def test_playtest_rejects_changed_locked_source_before_any_cad_process(self):
        ...
        with mock.patch("inventor_workshop.agent_make.subprocess.run") as launched:
    ...
    def test_prusaslicer_prefers_fixed_application_before_ambient_path(self):
        ...
        with mock.patch.object(
            ...
            "inventor_workshop.agent_playtest.shutil.which",
    ...
    def test_default_print_waits_without_all_slicer_configuration(self):
        context = self.playtest_context()
        with mock.patch(
            "inventor_workshop.agent_playtest._recheck_locked_cad",
