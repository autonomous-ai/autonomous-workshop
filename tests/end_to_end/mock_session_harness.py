    ...
    for turn in trace:
        ...
        for relative in writes:
            allowed = (
                ...
                or relative == ".cache/ezdxf/font_manager_cache.json"
                or relative == ".workshop-cache/xdg/ezdxf/font_manager_cache.json"
                or relative == ".work-cache/ezdxf/font_manager_cache.json"
...
def _fixed_wish(product_id: str) -> Wish:
    return Wish.create(
        ...
        (
            ...
            "verify_project command with --fresh --exports --strict-fit and refresh "
            "all declared generated bytes before finalizing. Use no connectors, "
            "relief, text, hardware, electronics, or moving joints."
        ),
        constraints={
