...
def _verify_declared_dependencies(python: Path, *, cwd: Path) -> None:
    ...
    _run(
        (
            ...
            "assert 'build123d==0.11.1' in requirements, requirements; "
            "assert 'cadquery-ocp==7.9.3.1.1' in requirements, requirements; "
            ...
            "assert m.version('build123d') == '0.11.1'; "
            "assert m.version('cadquery-ocp') == '7.9.3.1.1'; "
