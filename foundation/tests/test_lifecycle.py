...
from inventor_core.errors import TransitionError
from inventor_core.lifecycle import GatePolicy, Pipeline, PipelineSpec
from inventor_core.models import GateResult, PublicationReceipt
...
class LifecycleTest(unittest.TestCase):
    ...
    def record_draft(self):
        intent = self.store.prepare_publish(
            ...
            {
                "status": "draft",
                "_core_artifact_sha256": ARTIFACT,
                "_core_owner_id": "owner",
    ...
    def test_gate_policy_rejects_stale_and_future_evidence(self):
        ...
        with mock.patch(
            "inventor_core.lifecycle.utc_now",
