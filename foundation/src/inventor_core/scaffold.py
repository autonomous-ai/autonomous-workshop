"""Create a Foundation-connected inventor without copying another harness."""
...
def _files(inventor_id: str, name: str, niche: str) -> Dict[str, str]:
    ...
    manifest = {
        ...
        "name": name,
        "niche": niche,
        "summary": "A Foundation-connected autonomous inventor for %s." % niche,
        "autonomy": "autonomous",
        "status": "experimental",
...
Write the niche-specific creative thesis, target player, mechanism families,
and reward hypothesis here. Complete `TASTE.md` with recognizable preferences
and explicit rejects. This folder owns those choices. Shared
...
```bash
python3 -m pip install -e ../../foundation -e .
{package} init
...
gate bound to exact artifact bytes, and publish draft-first through Foundation.

## Pipeline

The starter uses Foundation's conservative board-game lifecycle. Replace or extend
