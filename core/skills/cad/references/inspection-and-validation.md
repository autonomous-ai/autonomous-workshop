...
printf '%s\n' \
  ...
  | CADGEN_WARM=1 python scripts/inspect batch
```
...
```bash
python scripts/inspect validate <project-dir>/<name>.step.py
python scripts/inspect validate <project-dir>/<name>.step.py --refs o1.2      # one subassembly
python scripts/inspect validate <project-dir>/<name>.step.py --allow-open   # surfaces intended
```
...
```bash
python scripts/inspect interfere <project-dir>/<name>.step.py
python scripts/inspect interfere <project-dir>/<name>.step.py --refs o1.1,o1.7
python scripts/inspect interfere <project-dir>/<name>.step --tolerance 25
```
