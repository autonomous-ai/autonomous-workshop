...
The `core/src` implementation and `product-to-cad` skill were authored for this
...
`core/skills/cad` and `core/skills/step-parts` were moved without modification
...
The three top-level imported inventor snapshots have individual `UPSTREAM.md`
