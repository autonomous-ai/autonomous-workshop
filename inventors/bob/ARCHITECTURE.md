...
- `toys/<slug>/` holds the exact artifacts for one game.
...
- `toys/<slug>/send.json` is an operator projection, never authority by itself.
- `toys/<slug>/pack/` contains the current artifact archive and rehearsal
