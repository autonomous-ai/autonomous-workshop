"""Eve's deliberately small boundary to the Inventor Foundation.

Eve remains the authority for her creative queue, gates, and reward ledger.
The Foundation owns two infrastructure facts that must not be reinvented here:
...
def snapshot_built_game(game_dir: Path) -> Dict[str, Any]:
    ...
    the game in either Eve's queue or Foundation's lifecycle graph.
    """
...
def import_panda_draft(
    ...
    *,
    ...
    """Import one exact Eve artifact through Foundation's durable Panda outbox."""
