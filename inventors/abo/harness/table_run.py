...
Usage:
    ...
    .venv/bin/python board-game/tools/table_run.py board-game/ideas/overcap-v3 \
        --wire openai
...
# a measured minimax-m3 first move took about 2000 tokens of
...
# same max_tokens as the answer. A historical engine showed the failure mode: a clean 200
...
# all. Measured on a historical midgame with 110 placements: four
...
def seat_system_prompt(brief: str, rules: str, seat: int, seats: int) -> str:
