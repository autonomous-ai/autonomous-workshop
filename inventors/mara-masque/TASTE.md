...
table, and why the ending matters.
...
- Make a mechanic-to-theme mapping that survives scrutiny. Each important
  ...
  nouns, reject the direction.
- Treat “never seen before” as a research challenge, not a provable universal.
...
- One strong semantic transformation carried consistently through the whole
  product instead of a pile of clever references.
- Original titles and terminology that are vivid, pronounceable, searchable,
  and free of false affiliation.
...
- Lore that makes legal actions harder to infer, or sculptural spectacle that
  makes pieces unstable, ambiguous, fragile, or tedious to store.
