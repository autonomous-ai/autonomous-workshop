...
artifact-bound :class:`~workshop.runtime.contracts.Receipt`.
...
from workshop.errors import AmbiguousSendError, ContractError, StateConflict
from workshop._validation import require_json_mapping
from workshop.runtime.contracts import Receipt, SendResult
...
class Runtime(InventorStore):
    ...
    def reconcile(self, intent_id: str, adapter: Any) -> Optional[Receipt]:
        ...
        result = reconcile_effect(self, intent_id, adapter, canonical_intent=True)
...
# Source-compatibility aliases for Workshop 0.5 and older. Other Workshop
# components use the documented public functions above.
_perform = perform_effect
_reconcile = reconcile_effect

__all__ = ["Runtime", "perform_effect", "reconcile_effect"]
