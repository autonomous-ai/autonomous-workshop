...
trusted host. Explicit regeneration is not proof that the shared-library cache
defect is repaired; inspect the changed geometry and let the trusted fresh
rebuild establish freshness. Do not repeatedly delete the cache between commands that all
