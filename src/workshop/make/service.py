...
from workshop._validation import require_json_mapping, require_sha256
from workshop.contributors import Taste, load_taste
from workshop.wish.contracts import Wish

if TYPE_CHECKING:
    from workshop.playtest import Playtest, PlaytestResult
...
class MakeResult:
    ...
    def assert_valid(self) -> None:
        ...
        if self.inspections:
            # Compatibility-only: modern Make returns no Playtest evidence.
            # Load the Playtest contract only while reading an old combined
            # MakeResult so importing Make never initializes Playtest.
...
class Workbench:
    ...
    def playtest(
        ...
        *,
        ...
        from workshop.playtest import Playtest
