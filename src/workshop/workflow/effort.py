...
# Keep unavailable to ordinary new runs until authenticated acceptance is recorded.
# An acceptance run may opt in without changing any frozen existing checkpoint.
INVENT_CONCEPT_V3_ACTIVATED = False
INVENT_CONCEPT_V3_ACCEPTANCE_ENVIRONMENT = (
    "WORKSHOP_INVENT_CONCEPT_V3_ACCEPTANCE"
)
