...
from workshop.contributors.contracts import CUSTOMIZATION_LEVELS
...
from workshop import Made, MakeContext, Need, WaitingFor
...
from workshop import PlaytestContext, Playtested
...
dependencies = ["autonomous-workshop>=0.6,<0.7"]
...
from workshop import WORKSHOP_JOBS, Workshop, WorkshopTools, load_taste
...
def create_inventor(
    ...
    *,
    ...
    try:
        ...
        from workshop.contributors.contribution import run_declared_checks, validate_contribution
        ...
        # Validate contributor-owned identity and entrypoint invariants before
        # publication. Match builds routing cards only after the folder exists.
        from workshop.contributors.contribution import validate_inventor_collection

        validate_inventor_collection(
            staging_root, required_routable_id=inventor_id
        )
        if source_taste is not None:
