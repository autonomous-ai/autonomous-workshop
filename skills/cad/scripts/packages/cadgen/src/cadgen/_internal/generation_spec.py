...
def _resolve_cli_output_path(
    ...
    *,
    ...
    # typed on the wrong machine, which would otherwise silently create a drive-rooted file
    # in the working directory. On Windows it must not fire at all: this is a
