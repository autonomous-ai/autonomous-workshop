...
```bash
python scripts/gen <project-dir>/<name>.step.py --write

python scripts/export <project-dir>/<name>.step.py \
  --stl <project-dir>/meshes/<name>.stl \
  --glb <project-dir>/meshes/<name>.glb \
  --mesh-tolerance 0.2 \
  --mesh-angular-tolerance 0.2

python scripts/inspect refs <project-dir>/<name>.step --facts --planes --positioning
```
